...
router.get("/searchAssistente", authGuard, searchPacienteAssistente);
...
router.get("/medico/:userId", authGuard, getPacientePorMedico);
router.get("/medicos", authGuard, getMedicosComPacientes);
